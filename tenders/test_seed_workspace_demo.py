...
class SeedWorkspaceDemoCommandTests(TestCase):
    def test_seed_workspace_demo_creates_complete_business_data(self):
        ...
        self.assertGreaterEqual(Contract.objects.count(), 50)
        self.assertLessEqual(Contract.objects.count(), 60)
        self.assertGreaterEqual(TenderReference.objects.count(), 50)
        self.assertLessEqual(TenderReference.objects.count(), 60)
